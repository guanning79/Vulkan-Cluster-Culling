...
public:
    ...
    void AddStorageBuffers(VkDeviceSize _size, void* _data, const char* _bufName, VkBufferUsageFlags _addtionalFlags = 0);
    void CreateDescriptorSet();
    VkBuffer GetStorageBuffer(const char* _bufName);
